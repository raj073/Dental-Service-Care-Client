        ...
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                ...
                <div className="flex mt-4 gap-x-2">
                    ...
                    <button onClick={handleGithubSignIn} type='button' className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:bg-purple-600 focus:text-white hover:bg-purple-700 hover:text-white">
