...
const MyReviews = () => {
    ...
    useEffect(() => {
        fetch(`https://b6a11-service-review-server-side-raj073-main.vercel.app/reviews?email=${user?.email}`, {
            headers: {
    ...
    const handleDelete = id => {
        ...
        if (proceed) {
            fetch(`https://b6a11-service-review-server-side-raj073-main.vercel.app/reviews/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
