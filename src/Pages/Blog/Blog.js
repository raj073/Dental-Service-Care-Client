            ...
            <div className='questions'>
                ...
                <div class="accordion-bral">
                    ...
                    <div>
                        ...
                        <label class="ac-label" for="ac-2">Q1. Difference between SQL and NoSQL?<i></i></label>
                    ...
                    <div>
                        ...
                        <label class="ac-label" for="ac-3">Q2. What is JWT, and how does it work?<i></i></label>
                        <div class="article ac-content">
                    ...
                    <div>
                        ...
                        <label class="ac-label" for="ac-4">Q3. What is the difference between javascript and NodeJS?<i></i></label>
                        <div class="article ac-content">
                    ...
                    <div>
                        <input class="ac-input" id="ac-3" name="accordion-1" type="checkbox" />
                        <label class="ac-label" for="ac-3">Q-4. How does NodeJS handle multiple requests at the same time?<i></i></label>
                        <div class="article ac-content">
